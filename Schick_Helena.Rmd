...
df_train <- subset(df_train, funding_total_usd < 100000000)
```
...
In the first phase of the model process, the initial models are generated and their performance is compared during model evaluation.
...
log_res_2 <- 
  ...
  fit_resamples(
    resamples = cv_folds, 
    metrics = metric_set(
      yardstick::recall, yardstick::precision, f_meas, 
      accuracy, kap,
