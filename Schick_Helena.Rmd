...
As the data is not too complex, neural networks are not needed. Instead, three common classification algorithms are compared:
...
- K-Nearest Neighbors: Finds the distances between a query and all the examples in the data, selecting the specified number examples (K) closest to the query, then votes for the most frequent label.
