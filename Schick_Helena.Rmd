...
Data analysis is done through R and SQL. To use SQL in RStudio a connection is created and the following code cells start with {sql connection=...} instead of {r}.
```{r}
